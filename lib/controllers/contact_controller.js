...
exports.getContactById = exports.deleteContact = exports.updateContact = exports.getContacts = exports.crearContact = void 0;
const mongo_connect_1 = require("../db/mongo_connect");
const mongodb_1 = require("mongodb");
const crearContact = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = req.body;
...
exports.crearContact = crearContact;
...
const updateContact = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const collection = yield (0, mongo_connect_1.dbConnection)('contacts');
        const document = yield collection.updateOne(query, { $set: contactData });
        return res.status(200).json(document);
    }
    catch (error) {
...
const deleteContact = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const document = yield collection.deleteOne({ _id: new mongodb_1.ObjectId(contactId) });
        return res.status(200).json(document);
    }
    catch (error) {
...
const getContactById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const contactId = req.params.id;
        const collection = yield (0, mongo_connect_1.dbConnection)('contacts');
        const document = yield collection.findOne({ _id: new mongodb_1.ObjectId(contactId) });
        return res.status(200).json(document);
    }
    catch (error) {
